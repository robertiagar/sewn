namespace Sewn.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AccepterId = c.String(nullable: false, maxLength: 128),
                        Added = c.DateTime(nullable: false),
                        Updated = c.DateTime(nullable: false),
                        Status = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.RequesterId, t.AccepterId })
                .ForeignKey("dbo.AspNetUsers", t => t.AccepterId)
                .ForeignKey("dbo.AspNetUsers", t => t.RequesterId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Friendships", "RequesterId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Friendships", "AccepterId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Friendships", new[] { "AccepterId" });
